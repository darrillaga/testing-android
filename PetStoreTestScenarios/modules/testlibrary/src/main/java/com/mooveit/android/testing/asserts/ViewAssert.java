...
public class ViewAssert {
    ...
    /**
     * Assert two bitmaps are equals according to
     * {@link Bitmap#sameAs(Bitmap)}
     * @param a
     * @param b
     */
    ...
    /**
     * Assert two bitmaps are not equals according to
     * {@link Bitmap#sameAs(Bitmap)}
     * @param a
     * @param b
     */
    public static void assertNotEqualBitmap(Bitmap a, Bitmap b) {
        Assert.assertFalse(a.sameAs(b));
    }
